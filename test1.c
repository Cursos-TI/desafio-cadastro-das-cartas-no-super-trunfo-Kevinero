...
float area, area2, pib, pib2, densidade, densidade2, pibcapita, pibcapita2, superpodercarta1, superpodercarta2 , carta1, carta2;
unsigned long int populacao, populacao2; //Nivel Mestre
...
superpodercarta1 = (populacao+area+pib+pontosturisticos+densidade+pibcapita);
superpodercarta2 = (populacao2+area2+pib2+pontosturisticos2+densidade2+pibcapita2);

printf("***Confronto das Cartas***\n");
